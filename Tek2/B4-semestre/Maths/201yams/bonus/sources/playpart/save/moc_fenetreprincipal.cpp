/****************************************************************************
** Meta object code from reading C++ file 'fenetreprincipal.hpp'
**
...
#include "../includes/fenetreprincipal.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'fenetreprincipal.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_FenetrePrincipale[] = {
    ...
    "changerPageAPropos()\0play1()\0play2()\0"
};
...
void FenetrePrincipale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->play1(); break;
        case 3: _t->play2(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
