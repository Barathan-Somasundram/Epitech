...
// Last update Mon Jan 19 11:27:16 2015 SOMASUNDRAM Barathan
//
...
int		main()
{
  ...
  coppo = toto;
  if (coppo.getType() == Toy::BASIC_TOY)
  std::cout << "basic toy: " << coppo.getName() << std::endl
	    << coppo.getAscii() << std::endl;
  if (cop.getType() == Toy::ALIEN)
  std::cout << "this alien is: " << cop.getName() << std::endl
  << cop.getAscii() << std::endl;
  return 1337;
}
