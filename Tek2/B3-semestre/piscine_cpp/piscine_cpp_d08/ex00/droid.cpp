...
// Last update Thu Jan 15 09:34:23 2015 SOMASUNDRAM Barathan
//
...
{
  if (this->Id == original.Id && this->Energy == original.Energy
      && this->Attack == original.Attack && this->Toughness == original.Toughness
      && *this->Status == *original.Status)
    return (true);
  return (false);
}
